package net.nilsgk.thermies_tinkering;
...
@Mod(ThermiesTinkering.MODID)
public class ThermiesTinkering
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "thermies_tinkering";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public ThermiesTinkering(FMLJavaModLoadingContext context)
    {
